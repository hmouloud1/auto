...
public class BisFormLib{
	...
	*/
	public static void submitBisForm() throws Exception
	{
		...
		if(!checkElementExists(guiMap.get("submitForm")))
		{
			...
			failTestCase("Review form", "The form should be edited for review", 
					"Not as expected", "VP", "fail", "review form");
		}
		else
		{
			setBrowserTimeOut(currentTimeOut);
			updateHtmlReport("Review form", "The form should be edited for review", 
					"As expected", "VP", "pass", "review form");
	...
	*/
	public static void searchExclusiveRequestById(String reqId) throws Exception
	{
		...
		//int currentTimeOut = setBrowserTimeOut(11);
