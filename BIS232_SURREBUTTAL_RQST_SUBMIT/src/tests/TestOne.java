...
public class TestOne {
	...
	static ArrayList<LinkedHashMap<String, String>> scenarios, dataPoolStep1, dataPoolStep5;
	...
	public static void main(String[] args) throws Exception 
	{
		...
		String dataPoolPath = InitTools.getInputDataFolder()+"\\datapool\\SURREBUTTAL_REQUEST.xlsx";
	...
	*/
	...
	void validate(int i, LinkedHashMap<String, String> row) throws Exception
	{
		...
		{
			//testCaseStatus = false;
			failTestCase("Submission", "User is not able to submit form", 
					"Not as expected", "VP", "fail", "Submission");
		}else
		{
			String timeToUpload = "";
